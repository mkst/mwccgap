...
glabel func_01F6DA90_hospital_b_00
    /* 490 01F6DA90 00008394 */  lhu        $v1, 0x0($a0)
    /* 494 01F6DA94 F1FF6320 */  addi       $v1, $v1, -0xF /* handwritten instruction */
    /* 498 01F6DA98 0600612C */  sltiu      $at, $v1, 0x6
    /* 49C 01F6DA9C 4F002010 */  beqz       $at, .L01F6DBDC_hospital_b_00
"""
        c_lines, rodata_entries = Preprocessor().preprocess_s_file(
            "comments.s", asm_contents.splitlines()
        )
